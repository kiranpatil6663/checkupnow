...
const Appointment = () => {
  ...
  currentDate = new Date(); // set to now
  currentDate.setMinutes(currentDate.getMinutes() + 30 - (currentDate.getMinutes() % 30)); // round to next half-hour
  ...
  const bookAppointment = async () => {
    ...
    try {
      ...
      if(data.success){
        ...
        getDoctorsData()
        navigate('/MyAppointment');scrollTo(0,0);
      }else{
      ...
      <div>
        ...
        <div className="flex flex-colsm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div>
              <p className="flex items-center gap-1 text-sm font-medium text-gay-900 mt-3">
